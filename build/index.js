...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/settings.js");
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_1__.registerPlugin)('dlxgb-commands', {
  render: GBCommands
});
...
/* harmony import */ var _utils_SendCommand__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/SendCommand */ "./src/js/blocks/utils/SendCommand.js");
...
var PatternImporter = function PatternImporter(props) {
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]),
    ...
    patternBackgroundImages = _useState6[0],
    setPatternBackgroundImages = _useState6[1];
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false),
    _useState8 = _slicedToArray(_useState7, 2),
    importing = _useState8[0],
    setImporting = _useState8[1];
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
              ...
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(imgUrl, imgAlt) {
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return (0,_utils_SendCommand__WEBPACK_IMPORTED_MODULE_9__["default"])(gbHacksPatternInserter.restNonce, {
                        imgUrl: imgUrl,
                        imgAlt: imgAlt
            ...
            Promise.all(imagePromises).then(function () {
              var gbUniqueIdMatches = _toConsumableArray(localPatternText.matchAll(uniqueIdRegex));
              ...
              if (gbUniqueIdMatches.length) {
                ...
                gbUniqueIdMatches.forEach(function (match) {
  ...
  var generateUniqueId = function generateUniqueId() {
    ...
    var newUniqueId = lodash_uniqueid__WEBPACK_IMPORTED_MODULE_3___default()(prefix);
  ...
  var block = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Card, {
    className: "dlx-pattern-inserter"
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.CardHeader, null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Pattern Importer', 'alerts-dlx')), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.CardBody, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextareaControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Paste your pattern here', 'alerts-dlx'),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Paste your pattern here', 'alerts-dlx'),
    value: patternText,
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Import', 'alerts-dlx')), importing && /*#__PURE__*/React.createElement("span", {
    className: "gb-pattern-importer-image"
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Spinner, null), "Processing ".concat(imageCount, " of ").concat(patternImages.length, " images.")))));
...
/* harmony default export */ __webpack_exports__["default"] = (PatternImporter);
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","title":"Pattern Inserter","apiVersion":2,"name":"dlxplugins/gbhx-pattern-inserter","category":"generateblocks","icon":"","description":"Paste in a pattern and it will be inserted for you.","keywords":["generateblocks","pattern","inserter"],"version":"1.0.0","textdomain":"gb-hacks","attributes":{"preview":{"type":"boolean","default":false}},"example":{"attributes":{"preview":true}},"editorScript":"gb-hacks-pattern-inserter-block"}');
...
/* harmony import */ var _js_blocks_pattern_importer_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/blocks/pattern-importer/index.js */ "./src/js/blocks/pattern-importer/index.js");
/* harmony import */ var _js_blocks_commands_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/blocks/commands/index.js */ "./src/js/blocks/commands/index.js");
...
(function (wp) {
  ...
  var defaultHeadlineBlockEnabled = gbHacksPatternInserter.defaultHeadlineBlockEnabled;
  ...
  wp.data.subscribe(function () {
    ...
    (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.setDefaultBlockName)('generateblocks/headline');
    ...
    if (blockIndex > 0) {
      var previousBlock = wp.data.select('core/block-editor').getBlocks()[blockIndex - 1];
