...
/* harmony import */ var _modals_RefreshCSSFilesModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modals/RefreshCSSFilesModal */ "./src/js/blocks/commands/components/modals/RefreshCSSFilesModal.js");
...
function useRefreshCSSFilesCommand() {
  ...
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    ...
    warning = _useState0[0],
    setWarning = _useState0[1];
  (0,_wordpress_commands__WEBPACK_IMPORTED_MODULE_1__.useCommand)({
    ...
    callback: function callback() {
      ...
      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()({
        ...
        setIsLoading(false);
        if (result.success) {
          setMessage(result.response || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('CSS files regenerated successfully.', 'dlx-gb-extras'));
          setTimeout(function () {
            setIsOpen(false);
          }, 2000);
        } else {
          setError(true);
          setMessage(result.response || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Failed to regenerate CSS files.', 'dlx-gb-extras'));
        }
      })["catch"](function (err) {
        setIsLoading(false);
        ...
        if (err.code === 'rest_forbidden' || err.status === 401 || err.status === 403) {
          setError(true);
          setMessage((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('You do not have permission to refresh CSS files.', 'dlx-gb-extras'));
        } else {
          setError(true);
          setMessage(err.message || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('An error occurred while regenerating CSS files.', 'dlx-gb-extras'));
        }
      });
    },
    context: 'admin' // Works in both admin and block editor.
  });
  return /*#__PURE__*/React.createElement(_modals_RefreshCSSFilesModal__WEBPACK_IMPORTED_MODULE_3__["default"], {
    isOpen: isOpen,
...
var RefreshCSSFilesModal = function RefreshCSSFilesModal(_ref) {
  ...
  var messageColor = '#00a32a'; // Success color.
  if (error) {
 ...
 */
var CommandsAdmin = function CommandsAdmin() {
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_1__.registerPlugin)('dlxgb-commands-admin', {
...
/******/ })()
;
//# sourceMappingURL=gb-extras-commands-admin.js.map